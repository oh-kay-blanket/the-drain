...
export const storyTree = {
  ...
  strike_first: {
    ...
    combat: {
      hitChance: 0.7,
      hitText:
        "You jab the blade into a cluster of eyes. It shrieks and recoils. A slick, oil-like substance drips from the wound. It staggers, legs folding unevenly. You've wounded it badly.",
      missText:
        "You go for a stab, but it pierces its foaming fangs through your hand. The wound is incredibly painful and you begin to feel a tingling sensation up the length of your arm. A venom is working through you.",
  ...
  venom_fight: {
    ...
    combat: {
      hitChance: 0.35,
      hitText:
        "The blade catches it across the abdomen and it splits open, spilling its contents across the counter. You collapse into the mess. When you wake up on the kitchen floor hours later, you're alive but your hand has changed. The skin around the bite has hardened into something chitinous. You scratch at it. Bristles emerge. Over the following weeks, they spread.",
      missText:
        "You miss completely. The creature leaps onto your chest. You feel a sharp, cold sting in your sternum as it drives a proboscis through your shirt and into the flesh beneath. It's not feeding — it's depositing something. Your vision goes dark.",
  ...
  leave_kitchen: {
    text: "You back into the hallway and close the kitchen door. You sit with your back against it, heart pounding, trying to figure out what to do. After twenty minutes of silence, you hear the TV turn on in the living room. That's impossible — the living room is past the kitchen. You open the door. The kitchen is empty. The creature is gone. But the drain is still broken open. On the floor between the kitchen and the living room, you notice thin, translucent fragments — curved and brittle, like shed pieces of a shell. A trail of them. In the living room, a dark-haired woman is sitting on the couch watching old cartoons. She's eating cereal. She looks up at you and smiles. 'You're out of milk.' she says, and turns back to the screen. She looks comfortable.",
    speed: 30,
  ...
  ask_wants: {
    text: '"What do you want?" you ask. The creature tilts its body. Its legs reposition. It moves to the edge of the counter and looks down at the floor, then back at you. It clicks twice and then does something strange — it extends one leg and points downward. Once. Twice. Then it taps the counter beneath itself. It\'s pointing: down there, then up here.',
    speed: 28,
    choices: [
  ...
  help_down: {
    text: "You hold your hand flat on the counter near the creature. It hesitates, then climbs on. It's surprisingly light for its size, like holding a bundle of warm pipe cleaners. You set it on the floor. It immediately scurries toward the window above the sink — the one that doesn't lock. It taps at the glass. It wants out. You push the window open. The night air is warm. The creature pauses on the sill, looks back at you with all those dark eyes, clicks once — softly — and then scrambles down the fire escape and disappears into the storm drain in the alley three floors below. You lean out and watch the empty street for a long time. You hope it'll be okay out there.",
    speed: 30,
    ending: { type: "happy", title: "FREEDOM" },
  },

  block_drain: {
    text: "You grab the rubber drain stopper and jam it in hard while the creature watches from the far side of the counter. You tape over it. Caulk the edges. The creature clicks urgently — almost frantically. Then it goes quiet and climbs down from the counter. It moves to the kitchen floor and sits in the middle of the tile, legs folded. Waiting. In the morning, you find it in the same spot. But there are thirty more around it. Small ones, each no bigger than a bottle cap. They came up through the bathroom drain, the washing machine outlet, the floor drain by the water heater. They came for the one you trapped up here. And they keep coming.",
    speed: 32,
  ...
  stop_listen: {
    ...
    choices: [
      {
        text: 'Call back down the drain — "Who\'s there?"',
        next: "respond_drain",
      },
  ...
  respond_drain: {
    ...
    choices: [
      ...
      {
        text: "Seal the drain and every other opening",
        next: "seal_everything",
      },
    ],
  },
